...
<li>
  ...
  <li>
    ...
    <ul dir="auto">
      ...
      <li><a href="https://github.com/TechGiovanni/Network-Security-Lab">Via using Cisco IOS to setup Variable TCP/IP Addresses and Routes, setup Firewall Rules and Aliases, Using Splunk Enterprise as our SOC (SIEM), and using Windows Servers at the core</a></li>
    </ul>
  </li>
  <br>
